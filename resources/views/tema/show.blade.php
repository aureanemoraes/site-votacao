                  ...
                  <form class="" action="{!! url()->current() !!}" method="post">
                    ...
                    <div class="panel-body">
                        ...
                        <?php foreach ($opcoes as $key => $value): ?>
                          <p><input type="radio" name="opcao" value="{!! $value->id !!}"> {!! $value->opcao !!} ({!! $value->quantidade !!})</p>
                          <?php if ($value->quantidade!=0): ?>
                            <div class="progress">
                              <div class="progress-bar" role="progressbar" style="width: {!! round(($value->quantidade/$total)*100) !!}%;">
                                 <span class="">{!! round(($value->quantidade/$total)*100) !!}%</span>
                              </div>
                            </div>
                          <?php endif; ?>
                        <?php endforeach; ?>
